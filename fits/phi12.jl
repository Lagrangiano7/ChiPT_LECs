...
chisq(p, d) = sum( (d .- model(value.(phi2), value.(a2t0), value.(phi4), p)) .^2 ./ (ADerrors.err.(phi12)).^2)
...
y = phi12./phi2
ErrUtils.LoadErr(y)
PlotUtils.ScatterByEnsemble(beta, phi2, y, L"\phi_2", L"\phi_{12}/\phi_2", latexstring("\\mathrm{Single\\ fit\\ of}\\ \\phi_{12}"), "phi12/phi12")

### Dumping details of params ###

ErrUtils.DumpErr(fitp, ["p1", "p2", "p3", "K", "C0", "C1"], "phi12")